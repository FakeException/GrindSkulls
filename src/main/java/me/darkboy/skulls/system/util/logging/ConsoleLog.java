...
import me.darkboy.skulls.system.util.Messages;
...
public class ConsoleLog {
    ...
    private String logFormat = "[&3Grind&bSkulls&r] [{grindskulls_log_level}]: {grindskulls_log_message}";
    ...
    public void log(ConsoleLevel level, String message, Object... args) {
        log(Messages.colour(logFormat
                .replace("{grindskulls_log_level}", level.getTagColour() + level.getTag() + ChatColor.RESET)
                .replace("{grindskulls_log_message}", message)), args);
    }
