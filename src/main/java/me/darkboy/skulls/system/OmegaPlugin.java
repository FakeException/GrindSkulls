package me.darkboy.skulls.system;

import com.google.common.collect.Lists;
import me.darkboy.skulls.system.inventory.InventoryManager;
import me.darkboy.skulls.system.register.Registrable;
import me.darkboy.skulls.system.util.logging.ConsoleLog;
import me.darkboy.skulls.system.util.logging.StaticLog;
import me.darkboy.skulls.system.util.reflect.Reflection;
...
public class OmegaPlugin extends JavaPlugin {
    ...
    public final void onLoad() {
        ...
        console.setFormat("[&3" + (description.getPrefix() != null ? description.getPrefix() : description.getName()) + "&r] [{grindskulls_log_level}]: {grindskulls_log_message}");
